...
var posX, posY;
   ...
   // svg.selectAll("rect").addEventListener('mouseover',function(){ grains(posX, posY);})
    ...
    svg.selectAll("rect")
        .on('mouseover', function (d) {
           ...
           posX = event.pageX;
            ...
            //timerID = setInterval(() => grains(posX,posY),10);
            grains(posX,posY)
        ...
        .on('mousemove', function (d) {
            ...
            console.log(grainSample);
            grains(event.pageX,event.pageY);
...
function playWhileHover(){
    console.log(posX,posY);
    requestAnimationFrame( function playWhileHover(){
        grains(posX,posY);
        if(sameSpot){
            console.log("same spot " +posX,posY);
            requestAnimationFrame(playWhileHover());
        }
    })
